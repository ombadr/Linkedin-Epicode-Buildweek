...
const ProfilePostsBar = () => {
    ...
    return (
        <>
            {profilopersonale && <div className="me-3">
                <div className="d-flex flex-column bg-light w-100 rounded-3 border border-secondary mt-4 mb-3 fs-5">
                        <div className="immaginebg text-center">
                            <img
                            className='mt-4 mb-4 rounded-circle'
                            width={80}
                            height={80}
                            ...
                            srcset=''
                          />             
                          <h3 className="fs-5">{profilopersonale.name} {profilopersonale.surname}</h3>
                          <p className="text-secondary fs-6">{profilopersonale.title}</p>
                        </div>
