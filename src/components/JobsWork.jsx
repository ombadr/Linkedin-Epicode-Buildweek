...
import Esempio from "./Assets/Esempio.webp";
            ...
            <Card className="mt-3">
              <Card.Body>
                ...
                <div className="WorkPhoto">
                  <h6>Show recruiters you're open to new job opportunities</h6>
                  <img src={User} alt="User" />
                </div>
                <br />
                <p>
                  Increase your chances of getting a job <br /> sooner when yor
                  are #OpenToWork - you <br /> control who sees this.
                </p>
                <a href="#">
            ...
            <Card className="mt-3">
              <Card.Body>
                ...
                <div className="WorkPhoto">
                  ...
                  <img id="esempio" src={Esempio} alt="Esempio" />
                </div>
                <br />
                <p>
                  Explore our curated guide of expert-led courses, such as how
                  to improve your resume and grow your network, to help you land
