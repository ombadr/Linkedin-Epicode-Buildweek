  ...
  return (
    <>
      ...
      <div className="Annuncio">
        <h6>Annuncio <IconContext.Provider value={{ className: "annuncio-rect-icon" }}>
            <BsThreeDots />
          </IconContext.Provider></h6>
        <p>Rimani al corrente sulle utlime notizie e aggiornamento del settore</p>
        <div>
          <img src="{User}" alt="User" />
          <img src="{EpicodeLogo}" alt="EpicodeLogo" />
        </div>
        <p id="Newsletter">Salvatore, rimani al corrente sulle utlime <br /> notizie da <strong>Epicode</strong></p>
