    ...
    <>
      <div className='border rounded my-2 bg-white'>
            ...
            <div className='d-flex'>
              ...
              <div>
                ...
                <p className='m-0 text-secondary'>
                  ...
                  {getDate(experience.endDate) === '1970-01-01'
                    ? 'Ad oggi'
              ...
              {modify && (
                <>
                  <Button
                    ...
                    className='d-flex align-items-center rounded-circle'
                    onClick={() => {
                      setElemento(experience);
                      handleShowModal1(!isModalOpen1);
                    }}
                  >
                    <LuPencil className='text-secondary ' size={24} />
                  </Button>
                  ...
                  <Button
                    ...
                    className='d-flex align-items-center rounded-circle'
                    onClick={() => {
                      setElemento1(experience._id);
                      handleShowModal2(!isModalOpen2);
                    }}
                  >
                    <CiImageOn size={24} />
                  </Button>
        ...
        <Modal show={isModalOpen1} onHide={handleCloseModal1}>
          ...
          <Modal.Body>
            <ExperienceFormModifica
              id={params}
              experience={elemento}
              getExperiences={getExperiences}
              chiudi={handleCloseModal1}
            />
          </Modal.Body>
